...
import resume from '../assets/React_developer.pdf'
  ...
  return (
    <div className='container-fluid bg-light pt-5 d-flex flex-column align-items-center min-vh-100'>
      <p className="text-center lead m-4">
        I'm a full stack web developer with 3+ years of experience in web development and coding. I love to create responsive websites using ReactJS, JavaScript, HTML5, CSS3, Bootstrap,Node js ,expressjs and mongo Db. 
